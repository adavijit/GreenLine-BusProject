		...
		<div class="container-fluid main-container">
			<div class="col-md-2 sidebar">
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="#" style="color: black;">DRIVER</a></li>
...
<script type="text/javascript" language="javascript" >
 $(document).ready(function(){
  ...
  $(document).on('click', '#insert', function(){
   var driver_name = $('#data1').text();
   var driver_phone_no = $('#data2').text();
	 var driver_address = $('#data3').text();
   ...
   if(driver_name != '')
   {
    $.ajax({
     ...
     method:"POST",
     data:{driver_name:driver_name, driver_phone_no:driver_phone_no,driver_address:driver_address},
     success:function(data)
     {
      $('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
      $('#user_data').DataTable().destroy();
